...
pub const DEFAULT_MODELS: &[ModelAsset] = &[
    ...
    ModelAsset {
        id: "speecht5-tts-encoder-quantized",
        filename: "speecht5_tts_encoder_quantized.onnx",
        relative_path: "models/acoustic/speecht5_tts/encoder_model_quantized.onnx",
        url: "https://huggingface.co/Xenova/speecht5_tts/resolve/main/onnx/encoder_model_quantized.onnx",
        expected_size_bytes: None,
        sha256: None,
        license: Some("MIT"),
    ...
    ModelAsset {
        id: "speecht5-tts-decoder-merged-quantized",
        filename: "speecht5_tts_decoder_model_merged_quantized.onnx",
        relative_path: "models/acoustic/speecht5_tts/decoder_model_merged_quantized.onnx",
        url: "https://huggingface.co/Xenova/speecht5_tts/resolve/main/onnx/decoder_model_merged_quantized.onnx",
        expected_size_bytes: None,
        sha256: None,
        license: Some("MIT"),
        source: Some("https://huggingface.co/Xenova/speecht5_tts"),
    ...
    ModelAsset {
        id: "speecht5-tts-config",
        filename: "speecht5_tts_config.json",
        relative_path: "models/acoustic/speecht5_tts/config.json",
        url: "https://huggingface.co/Xenova/speecht5_tts/resolve/main/config.json",
        expected_size_bytes: None,
        sha256: None,
        license: Some("MIT"),
        source: Some("https://huggingface.co/Xenova/speecht5_tts"),
    ...
    ModelAsset {
        id: "speecht5-tts-generation-config",
        filename: "speecht5_tts_generation_config.json",
        relative_path: "models/acoustic/speecht5_tts/generation_config.json",
        url: "https://huggingface.co/Xenova/speecht5_tts/resolve/main/generation_config.json",
        expected_size_bytes: None,
        sha256: None,
        license: Some("MIT"),
        source: Some("https://huggingface.co/Xenova/speecht5_tts"),
    ...
    ModelAsset {
        id: "speecht5-tts-preprocessor-config",
        filename: "speecht5_tts_preprocessor_config.json",
        relative_path: "models/acoustic/speecht5_tts/preprocessor_config.json",
        url: "https://huggingface.co/Xenova/speecht5_tts/resolve/main/preprocessor_config.json",
        expected_size_bytes: None,
        sha256: None,
        license: Some("MIT"),
        source: Some("https://huggingface.co/Xenova/speecht5_tts"),
    ...
    ModelAsset {
        id: "speecht5-tts-tokenizer",
        filename: "speecht5_tts_tokenizer.json",
        relative_path: "models/acoustic/speecht5_tts/tokenizer.json",
        url: "https://huggingface.co/Xenova/speecht5_tts/resolve/main/tokenizer.json",
        expected_size_bytes: None,
        sha256: None,
        license: Some("MIT"),
        source: Some("https://huggingface.co/Xenova/speecht5_tts"),
    ...
    ModelAsset {
        id: "speecht5-tts-tokenizer-config",
        filename: "speecht5_tts_tokenizer_config.json",
        relative_path: "models/acoustic/speecht5_tts/tokenizer_config.json",
        url: "https://huggingface.co/Xenova/speecht5_tts/resolve/main/tokenizer_config.json",
        expected_size_bytes: None,
        sha256: None,
        license: Some("MIT"),
        source: Some("https://huggingface.co/Xenova/speecht5_tts"),
    ...
    ModelAsset {
        id: "speecht5-tts-special-tokens-map",
        filename: "speecht5_tts_special_tokens_map.json",
        relative_path: "models/acoustic/speecht5_tts/special_tokens_map.json",
        url: "https://huggingface.co/Xenova/speecht5_tts/resolve/main/special_tokens_map.json",
        expected_size_bytes: None,
        sha256: None,
        license: Some("MIT"),
        source: Some("https://huggingface.co/Xenova/speecht5_tts"),
    ...
    ModelAsset {
        id: "speecht5-tts-added-tokens",
        filename: "speecht5_tts_added_tokens.json",
        relative_path: "models/acoustic/speecht5_tts/added_tokens.json",
        url: "https://huggingface.co/Xenova/speecht5_tts/resolve/main/added_tokens.json",
        expected_size_bytes: None,
        sha256: None,
        license: Some("MIT"),
        source: Some("https://huggingface.co/Xenova/speecht5_tts"),
    ...
    ModelAsset {
        id: "speecht5-tts-spm-char",
        filename: "speecht5_tts_spm_char.model",
        relative_path: "models/acoustic/speecht5_tts/spm_char.model",
        url: "https://huggingface.co/Xenova/speecht5_tts/resolve/main/spm_char.model",
        expected_size_bytes: None,
        sha256: None,
        license: Some("MIT"),
        source: Some("https://huggingface.co/Xenova/speecht5_tts"),
...
pub const MODEL_BUNDLES: &[ModelBundle] = &[
    ...
    ModelBundle {
        id: "speecht5-tts",
        display_name: "SpeechT5 TTS acoustic",
        kind: ModelKind::Acoustic,
        asset_ids: &[
            "speecht5-tts-encoder-quantized",
            "speecht5-tts-decoder-merged-quantized",
            "speecht5-tts-config",
            "speecht5-tts-generation-config",
            "speecht5-tts-preprocessor-config",
            "speecht5-tts-tokenizer",
            "speecht5-tts-tokenizer-config",
