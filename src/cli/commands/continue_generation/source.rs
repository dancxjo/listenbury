...
pub(super) fn execute_list_source_files() -> String {
...
pub(super) fn execute_view_source_file(path: &str, page: usize) -> String {
...
pub(super) fn execute_search_source(query: &str, limit: usize) -> String {
...
pub(super) fn execute_grep_source(pattern: &str, limit: usize) -> String {
